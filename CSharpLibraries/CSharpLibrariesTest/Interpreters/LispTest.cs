...
namespace CSharpLibrariesTest.Interpreters{
    public static class LispTest{
        ...
        public static void CaseTest3(){
            SchemeList t = (SchemeList) Interpreter.EvalScripts("(list (+ 1 1) (+ 2 2) (* 2 3) (expt 2 3))");
        ...
        public static void CaseTest9(){
            ...
            SchemeList r = (SchemeList) Interpreter.EvalScripts("(append (list 1 2) (list 3 4) (list 5 6))");
            Assert.AreEqual(l, r);
        }
    }
}